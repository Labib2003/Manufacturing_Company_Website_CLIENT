        ...
        <div className='mb-32'>
            ...
            <div className='card bg-base-200 shadow-xl mb-10'>
                <div className='card-body'>
                    ...
                    <p className='leading-normal'>We should never set the state directly in react because if we do that, the state wont change immediately. Instead, it creates a pending state transition, and accessing it after will only return the present value. Also calling the setState function may replace the current value of the state. That is why we use the setState function to update a state.</p>
                </div>
            </div>
            <div className='card bg-base-200 shadow-xl mb-10'>
                <div className='card-body'>
